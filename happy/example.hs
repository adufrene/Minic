...
happyReduce_12 = happyMonadReduce 0 8 happyReduction_12
happyReduction_12 (happyRest) tk
	 = happyThen (( getLineNo)
...
happyNewToken action sts stk
	...
	case tk of {
	TokenEOF -> action 20 20 tk (HappyState action) sts stk;
	TokenLet -> cont 9;
	TokenIn -> cont 10;
